...
As a personal project, I wanted a fast, no-frills way to spin up a container without having to remember the exact command every time — just pick a distro, pick a shell, and go.
